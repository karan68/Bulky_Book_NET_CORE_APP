...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        [Authorize] //need to log in to add to cart
        public IActionResult Details(ShoppingCart CartObject)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                var count = _unitOfWork.ShoppingCart
                    ...
                    .ToList().Count();
               // HttpContext.Session.SetObject(SD.ssShoppingCart, CartObject); //if the session is not datatype dependent
                HttpContext.Session.SetInt32(SD.ssShoppingCart, count);//if the session is totaaly inteager related
